...
export const badge =
  'absolute bottom-4 left-4 flex items-center gap-2 rounded-[0.625rem] bg-shell/95 px-3.5 py-2.5 text-[0.8125rem]';
export const badgeDot = 'h-2 w-2 rounded-full bg-live';

export const section = 'scroll-mt-6';
export const researchGrid = 'grid gap-[1.125rem] md:grid-cols-2';
export const story = 'mx-auto max-w-[40rem] space-y-5 px-2 text-[1.0625rem] leading-[1.7] sm:text-[1.125rem]';
